// Steve Tchuinte;
//
// this is GLCD_LPC1700.c that comes inside Example/SD_file/ example
// on the CD shipped with the LandTiger 2.0 board;
// I think it is a slightly modified version of the GLCD_SPI_LPC1700.c
// that used to come with Keil example SD_file example of the MCB1700 board;
//
// I have added some functions at the end of this file;
//
...
/*******************************************************************************
* Set foreground color     -- 	Steve don't need it                                                    *
...
/*******************************************************************************
* Clear display       -- 	Steve don't need it                                                         *
...
// Steve Tchuinte:
// I added the following functions from older versions of GLCD files;
...
// Steve Tchuinte : I added the following functions to be able to access them from main.c
void GLCD_WrDatStart( void) {
  wr_dat_start();
}

void GLCD_WrDatStop( void) {
  wr_dat_stop();
}

void GLCD_WrDatOnly( unsigned short dat) {
  wr_dat_only( dat);
}
